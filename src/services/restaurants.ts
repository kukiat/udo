...
export async function listRestaurants(opts: { withBranches: boolean }) {
...
export async function getRestaurant(id: string, opts: { withBranches: boolean }) {
...
export async function updateRestaurant(id: string, input: RestaurantUpdateInput) {
  const timed = makeTimer(
