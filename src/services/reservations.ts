...
export class ReservationService {
  ...
  async create(
    ...
    this.events.reservationUpdate(input.branchId);
   ...
   */
  async seat(id: string, input: ReservationSeatInput) {
    ...
    this.events.reservationUpdate(reservation.branchId);
  ...
  async cancel(id: string, input: ReservationCancelInput) {
    const timed = makeTimer(
