...
export async function listShifts(branchId: string, status: string | null) {
 ...
 */
export async function openShift(input: ShiftOpenInput, user: AuthUser) {
...
export async function closeShift(id: string, input: ShiftCloseInput) {
